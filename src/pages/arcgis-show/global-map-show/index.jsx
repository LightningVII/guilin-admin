  ...
  render() {
    return (
      <>
        ...
        <Affix
          className={style.measureCard}
          style={{ visibility: this.state.renderMeasure ? 'visible' : 'hidden' }}
          offsetTop={150}
        >
          <Card
            size="small"
        ...
        {this.state.showSwipeModal ? <ModalSwipeTree onSetSwipe={this.onSetSwipe} /> : null}

...
export const baseMapList = [
    ...
    },
    {
        ...
        subDomains: [0,1,2,3],
        copyright: '地图数据 © 2018 Google <a href="http://www.google.cn/maps" target="_blank">谷歌地图</a>',
        key: 'google_img',
...
export const labelMapList = [
    {
        ...
        subDomains: [0, 1, 2, 3],
        copyright: '地图数据 © 2018 <a href="http://lbs.tianditu.gov.cn/server/MapService.html target="_blank"">天地图</a>',
        key: 'tdtLabel',
